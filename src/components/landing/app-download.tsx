...
export function AppDownload() {
  ...
  return (
    <section ref={ref} className="app-download relative overflow-hidden bg-[var(--navy)] px-6 py-[120px]">
      <div className="pointer-events-none absolute right-0 top-1/2 h-[500px] w-[500px] -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(27,85,224,0.14)_0%,transparent_70%)]" />
      <div className="mx-auto grid max-w-[1200px] items-center gap-12 lg:grid-cols-[55%_45%]">
        <div className="download-copy">
          ...
          <ul className="mt-8 space-y-3 text-[var(--text-muted-dark)]">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href={`${APP_URL}/app`} className="rounded-full border border-[var(--border-dark)] px-6 py-3 font-bold text-[var(--text-on-dark)]">
              Play Store
            </a>
          </div>
          <div className="mt-8 flex items-center gap-4">
            <div className="relative h-24 w-24 overflow-hidden rounded-xl border border-[var(--border-dark)] bg-white">
            ...
            <p className="text-sm text-[var(--text-muted-dark)]">Scan to download</p>
          </div>
        </div>
