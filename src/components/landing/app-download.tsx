...
export function AppDownload() {
  ...
  return (
    <section ref={ref} className="app-download relative overflow-hidden bg-[var(--navy)] px-6 py-[120px]">
      <div className="pointer-events-none absolute right-0 top-1/2 h-[500px] w-[500px] -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(0,184,230,0.12)_0%,transparent_70%)]" />
