    ...
    >
      ...
      >
        {meta ? (
          ...
          <span className="block h-full w-full animate-pulse bg-[var(--surface)]" />
        )}
      ...
      <span className="flex min-w-0 flex-1 flex-col">
        ...
        <span
          className={`mt-1 truncate text-xs ${active ? "text-[var(--fg)]" : "text-[var(--fg-muted)]"}`}
        >
          {meta?.author ?? ""}
        </span>
        <span
    ...
    >
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-[1.6fr_1fr] lg:gap-7">
          <div
            className="discover-feature relative aspect-video overflow-hidden rounded-3xl border border-[var(--border)] backdrop-blur-sm"
          ...
          <div
            className="rounded-3xl border border-[var(--border)] p-3 backdrop-blur-sm sm:p-4"
            style={{ background: "var(--surface)" }}
          >
            <div className="flex items-center justify-between px-1 pb-2 text-[11px] font-semibold uppercase tracking-wider text-[var(--fg-subtle)]">
              <span>Up next</span>
